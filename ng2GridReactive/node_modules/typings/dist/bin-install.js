...
function exec(args, options) {
    ...
    emitter.on('reference', function (_a) {
        ...
        if (references.indexOf(reference) === -1) {
            cli_1.logInfo("Stripped reference \"" + reference + "\" during installation of \"" + name + "\"", 'reference');
    ...
    emitter.on('ambientdependencies', function (_a) {
        ...
        if (deps.length) {
            cli_1.logInfo("This definition lists ambient dependencies on " + listify(deps), 'ambient dependencies');
        }
    });
