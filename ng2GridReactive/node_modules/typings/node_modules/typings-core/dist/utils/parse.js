...
function parseDependency(raw) {
    ...
    if (type === 'github') {
        ...
        if (rc_1.default.githubToken) {
            location += "?token=" + encodeURIComponent(rc_1.default.githubToken);
        }
        return {
            raw: raw,
            meta: meta,
    ...
    if (type === 'registry') {
        ...
        var prefix = "/entries/" + encodeURIComponent(source) + "/" + encodeURIComponent(name);
        var path = tag ?
