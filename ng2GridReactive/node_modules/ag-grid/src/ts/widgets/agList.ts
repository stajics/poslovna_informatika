...
export class AgList {
    ...
    public addStyles(styles: any) {
        _.addStylesToElement(this.eGui, styles);
    }

    public addCssClass(cssClass: any) {
        _.addCssClass(this.eGui, cssClass);
    }
    ...
    private setupComponents() {
        ...
        _.removeAllChildren(this.eListParent);
    }
    ...
    private insertRows() {
        for (var i = 0; i < this.model.length; i++) {
            ...
            if (this.cellRenderer) {
                ...
                _.useRenderer(eListItem, this.cellRenderer, params);
            } else {
    ...
    private setDropCssClasses(eListItem: any, state: any) {
        _.addOrRemoveCssClass(eListItem, 'ag-not-drop-target', state === DropTargetLocation.NOT_DROP_TARGET);
        _.addOrRemoveCssClass(eListItem, 'ag-drop-target-above', state === DropTargetLocation.DROP_TARGET_ABOVE);
        _.addOrRemoveCssClass(eListItem, 'ag-drop-target-below', state === DropTargetLocation.DROP_TARGET_BELOW);
    }
